...
static const int64 DUST_SOFT_LIMIT = COIN * 10; // 0.001 MAN
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = COIN;   // 0.00001 MAN mininput
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // OLD MandarinCoin: 2880 blocks found a day (@ 30 seconds / block). Priority cutoff is 100 MandarinCoin day / 250 bytes.
        bool bAllowFree = dPriority > 100 * COIN * ( nBestHeight > HARDFORK_HEIGHT_1 ? 2880 : 1440 ) / 250;
        return bAllowFree;
    }
